  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg dark:shadow-gray-900/50 p-4 sm:p-8 mb-8">
      ...
      <Tabs defaultValue="data_types" className="w-full">
        <TabsList className="grid w-full grid-cols-3 gap-4 sm:gap-6 mb-4">
          <TabsTrigger value="data_types" className="px-2 sm:px-4 py-2 text-sm sm:text-base whitespace-nowrap">
            Data Types
          </TabsTrigger>
          <TabsTrigger value="workflows" className="px-2 sm:px-4 py-2 text-sm sm:text-base whitespace-nowrap">
            Workflows
          </TabsTrigger>
          <TabsTrigger value="design" className="px-2 sm:px-4 py-2 text-sm sm:text-base whitespace-nowrap">
            Design
          </TabsTrigger>
        </TabsList>
